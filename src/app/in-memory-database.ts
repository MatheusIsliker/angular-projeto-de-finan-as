...
export class InmemoryDataBase implements InMemoryDbService {
    ...
    createDb() {
        ...
        const entries: Entry[] = [
            { id: 1, name: 'Gás de cozinha', categoryId: categories[0].id, category: categories[0], paid: true, date: '14/03/2022', amount: '90,58', type: 'expense', paidText: 'Pedente' } as Entry,
            ...
            { id: 4, name: 'Cartão físico', categoryId: categories[0].id, category: categories[0], paid: true, date: '10/03/2022', amount: '500,00', type: 'expense', paidText: 'Pedente' } as Entry,
            ...
            { id: 7, name: 'Escola de música', categoryId: categories[2].id, category: categories[2], paid: true, date: '25/03/2022', amount: '200,00', type: 'revenue', paidText: 'Pedente' } as Entry,
            ...
            { id: 9, name: 'Internet', categoryId: categories[0].id, category: categories[0], paid: true, date: '31/03/2022', amount: '150,00', type: 'expense', paidText: 'Pedente' } as Entry,
            ...
            { id: 12, name: 'Roupas', categoryId: categories[2].id, category: categories[2], paid: true, date: '09/03/2022', amount: '250,00', type: 'expense', paidText: 'Pedente' } as Entry,
            ...
            { id: 14, name: 'Netflix', categoryId: categories[2].id, category: categories[2], paid: true, date: '19/03/2022', amount: '25,58', type: 'expense', paidText: 'Pedente' } as Entry,
        ]
